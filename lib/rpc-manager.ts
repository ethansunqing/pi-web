...
export class AgentSessionWrapper {
  ...
  async send(command: Record<string, unknown>): Promise<unknown> {
    ...
    switch (type) {
      ...
      case "compact": {
        // pi's compact() handles all validation internally via prepareCompaction().
        // Let it throw appropriate errors ("Already compacted", "Nothing to compact", etc.)
        // instead of duplicating fragile pre-check logic here.
